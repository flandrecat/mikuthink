...
<!--        <div class="form-item">
            ...
            <div class="controls">
                <label class="textarea input-large"><textarea id="auth-description" type="text" name="description"><?php echo ((isset($info["title"]) && ($info["title"] !== ""))?($info["title"]):''); ?></textarea></label>
            </div>
        </div>-->
        <div class="form-item">
    ...
    <script type="text/javascript" charset="utf-8">
        //导航高亮
        highlight_subnav('<?php echo U('Center/index');?>');
    </script>
