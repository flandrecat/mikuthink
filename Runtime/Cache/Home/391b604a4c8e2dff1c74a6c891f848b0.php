...
<div class="main">
    ...
    <!--导航结束-->
        ...
        <div class="container-fluid">
            <?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$inform): $mod = ($i % 2 );++$i;?><div class="row noticeList">
                <a href="<?php echo U('Index/informC?id='.$inform['id']);?>">
                    <div class="col-xs-2">
                        <img class="noticeImg" src="<?php echo ($inform["path"]); ?>" />
                    </div>
                    <div class="col-xs-10">
